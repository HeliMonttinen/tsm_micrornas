...
to create a fig from hsa-mir-605 as a few primates contain
a long insertion next to the microRNA locus.
...
def locus_ids(data_file):
    ...
    with open(data_file, 'r') as f:
        for line in f:
            ...
            end = int(locus.split(':')[1].split('-')[1])+50
            ...
            for loc in locus_dict:
                ...
                if chr_set == chromosome:
                    ...
                    end_set = int(loc.split(':')[1].split('-')[1])+50
