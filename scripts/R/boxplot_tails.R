...
dist = read.table("results/distances_tsms_all_LTR_tails_all.txt")[,7]

dat = cbind.data.frame(set="tsm",dist)

for(i in 1:100){
    dist = read.table(paste0("results/genome_wide_background_distance_full/background_tails_all_ltr_",i))[,7]
...
ggsave("results/transposons_enrichment/plot_ltr_tsm_all_tails.png",width=5,height=4)
